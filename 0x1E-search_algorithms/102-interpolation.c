 ...
 * @array: point to the first element of the array to search in
...
/**
 * interpolation -  interpolation_search help function
 * @array: is a first element of the array to search in
